...
**mercredi 2 septembre 2026 · 3 h**

## Au programme

- Classe et instance, `__init__`, `self`
- `@dataclass`, et le piège de `default=[]`
- `Enum` : en finir avec les chaînes magiques
- `@property` : l'attribut qui se recalcule
- Héritage ou composition — « est un » contre « a un »
