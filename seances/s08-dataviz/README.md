...
- `groupby` : découper, appliquer, combiner
- `merge`, et le piège de l'explosion de lignes
- Matplotlib : Figure et Axes, toujours l'interface orientée objet
- seaborn, et le choix du graphique selon la question
